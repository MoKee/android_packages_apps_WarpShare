...
class AirDropServer {
    ...
    int start(String host) {
        ...
        mServer.post("/Upload", new InputStreamHttpServerRequestCallback() {
            @Override
            protected void onRequest(InetAddress remote, InputStream input, NSDictionaryHttpServerResponse response) {
                handleUpload(remote, input, response);
            }
        });
    ...
    private void handleUpload(final InetAddress remote, final InputStream stream, final NSDictionaryHttpServerResponse response) {
    ...
    private abstract class InputStreamHttpServerRequestCallback implements HttpServerRequestCallback {
        ...
        public final void onRequest(AsyncHttpServerRequest request, final AsyncHttpServerResponse response) {
            ...
            onRequest(address, buffer.inputStream(), new NSDictionaryHttpServerResponse() {
                @Override
                public void send(int code) {
                    buffer.close();
                    response.code(code).end();
        ...
        protected abstract void onRequest(InetAddress remote, InputStream input, NSDictionaryHttpServerResponse response);
