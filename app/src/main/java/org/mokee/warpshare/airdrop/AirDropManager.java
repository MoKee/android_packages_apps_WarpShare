...
public class AirDropManager {
    ...
    void handleUpload(String ip, Source source, AirDropServer.ResultCallback callback) {
        ...
        try {
            AirDropArchiveUtil.unpack(Okio.buffer(source).inputStream(), new HashSet<>(mReceivingFiles), new AirDropArchiveUtil.FileFactory() {
                @Override
